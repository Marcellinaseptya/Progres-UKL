...
<body>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <p>Rekomendasi Wisata di Kota Malang. <br> Cocok untuk kamu yang suka Traveling!</p>
        ...
        <?php
            ...
            <div class="box">
                ...
                <div class="dest-content">
                    ...
                    <a href="halaman.php?id=<?php echo $data['IDwisata']; ?>"><button class="btn-pesan">Kunjungi</button></a>
