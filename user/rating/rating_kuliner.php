...
if (isset($_GET['IDtransaksi_kuliner'])) {
    $IDtransaksi_kuliner = $_GET['IDtransaksi_kuliner'];
} else {
...
<title>Beri Rating Kuliner</title>
...
<div class="rating-form">
    <h2>Beri Rating Kuliner</h2>
    <form action="submit_rating_kuliner.php" method="POST">
        <input type="hidden" name="IDtransaksi_kuliner" value="<?php echo $IDtransaksi_kuliner; ?>">
        <div class="rating">
...
<div class="existing-ratings">
    ...
    <?php
    $query_ratings = mysqli_query($mysqli, "SELECT * FROM rating_kuliner WHERE IDtransaksi_kuliner='$IDtransaksi_kuliner'") or die(mysqli_error($mysqli));
    if (mysqli_num_rows($query_ratings) > 0) {
