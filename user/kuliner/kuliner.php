...
<body>
    ...
    <header>
        ...
        <li><a href="../index.php">Home</a></li>
            ...
            <li><a href="/Project UKL/user/kuliner/kuliner.php">Kuliner</a></li>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <p>Rekomendasi kuliner di Kota Malang. <br> Cocok untuk kamu yang suka Traveling!</p>
    ...
    <section class="package" id="package">
        <div class="title">
            <h2>kuliner Terpopuler <br> Di Kota Malang!</h2>
        </div>
        ...
        <?php
            while($data = mysqli_fetch_array($query_mysql)) { 
                ...
                $query_rating = mysqli_query($mysqli, "SELECT AVG(rating) as average_rating FROM rating_kuliner WHERE IDtransaksi_kuliner 
                IN (SELECT IDtransaksi_kuliner FROM transaksi_kuliner WHERE IDkuliner='$IDkuliner')") or die(mysqli_error($mysqli));
            ...
            <div class="box">
                ...
                <div class="dest-content">
                    ...
                    <a href="halaman.php?id=<?php echo $data['IDkuliner']; ?>"><button class="btn-pesan">Kunjungi</button></a>
